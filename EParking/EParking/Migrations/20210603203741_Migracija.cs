        ...
        {/*
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProvedenoVrijeme = table.Column<int>(nullable: false),
                    UzastopnoVrijeme = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "IzabranaKategorijaVozila",
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    Vozilo = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IzabranaKategorijaVozila", x => x.ID);
                });
            ...
            */
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PocetakJeftinogVremena = table.Column<DateTime>(nullable: false),
                    KrajJeftinogVremena = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
